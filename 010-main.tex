% *************************************************************************
\chapter[Working title: Computational Enzyme Engineering and Activity Screening Using Quantum Chemical Methods.]
{Working title: Computational Enzyme Engineering and Activity Screening Using Quantum Chemical Methods.\label{ch1}}
...
\subsection{Quantum Chemical Methods}\label{sec:quantum_chemical_methods}
\textit{Every method has it's chemistry}.
...
Methods are of limited use if they can not be applied, therefore available modeling software is a very important factor.\\
...
\newpage
\subsection{\textit{Bacillus circulans} xylanase}
